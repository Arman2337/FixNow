              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    IconButton(
                      onPressed: () {
                        showFixBanner(ScaffoldMessenger.of(context), message: 'OTP Copied to clipboard');
                      },
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            child: const Row(
              children: [
                Icon(Icons.quickreply_rounded, color: AppColors.primary, size: 18),
                SizedBox(width: 8),
                Expanded(
                  child: Text.rich(
                    TextSpan(
            ...
            child: const Column(
              children: [
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text('Standard Inspection & Diagnosis',
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text('Emergency Dispatch Convenience Fee',
                        style: TextStyle(color: AppColors.textSecondary, fontSize: 12)),
                    Text('₹150',
                        style: TextStyle(
                            color: AppColors.textPrimary,
            ...
            children: [
              SizedBox(
                ...
                child: TextButton.icon(
                  onPressed: () {
                    showFixBanner(ScaffoldMessenger.of(context),
                        message: 'Booking cancellation initiated. No fee was applied.');
                  },
                  ...
                  children: [
                    ...
                    TextSpan(
                        ...
                        style: TextStyle(
                            ...
                            color: AppColors.textPrimary)),
                    TextSpan(
                        text: '. A ₹99 technician dispatch fee applies thereafter.'),
                  ],
                ),
                textAlign: TextAlign.center,
