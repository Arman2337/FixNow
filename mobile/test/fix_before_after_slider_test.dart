...
void main() {
  group('FixBeforeAfterSlider', () {
    testWidgets('renders badges, fallback placeholders and handle', (tester) async {
    ...
    testWidgets('renders with image bytes and responds to horizontal drag', (tester) async {
      await tester.pumpWidget(
        host(
