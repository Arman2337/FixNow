...
void main() {
  testWidgets(
    'renders Stitch Customer Help & Support screen elements correctly',
    (tester) async {
      ...
      expect(
        find.textContaining('FixNow 30-Day Rework Warranty'),
        findsOneWidget,
      );
      ...
      await tester.pumpAndSettle();
      expect(
        find.textContaining('How does FixNow Escrow protect my payment?'),
        findsOneWidget,
      );
    },
  );
