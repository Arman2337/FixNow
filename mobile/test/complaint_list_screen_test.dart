...
void main() {
  testWidgets(
    'renders Stitch Disputes & Cases Hub with active & resolved cases',
    (tester) async {
      final testComplaints = [
        Complaint(
          ...
          description:
              'Billing Discrepancy — Extra Gas Top-up Charged without Prior Consent',
          status: 'IN_REVIEW',
      ...
      final controller = ComplaintsController(
        _FakeComplaintsRepo(testComplaints),
      );
      ...
      await tester.scrollUntilVisible(
        find.text('Past Complaints History'),
        200,
      );
